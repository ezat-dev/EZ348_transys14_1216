...
public class TrackingServiceImpl3 implements TrackingService3{
	...
	public void ccf3Tracking01() throws InterruptedException, ExecutionException {
		//Transys.TRACKING.CCF03.C01의 하위태그 조회		
		String setDataDir = "Transys14.TRACKING.CCF03.C01";
		
		//호기, 위치(순서), 태그경로
		trackingDataSet("3",1,setDataDir);
	}
	
	//[2]예열장입 : 처리품이 예열실에 도착할 때
	public void ccf3Tracking02() throws InterruptedException, ExecutionException {
		//Transys.TRACKING.CCF03.C02의 하위태그 조회		
		String setDataDir = "Transys14.TRACKING.CCF03.C02";
	
		//호기, 위치(순서), 태그경로
		trackingDataSet("3",2,setDataDir);
	}
	
	//[3]침탄실(1) : 침탄 처리 시작위치
	public void ccf3Tracking03() throws InterruptedException, ExecutionException {
		//Transys.TRACKING.CCF03.C02의 하위태그 조회		
		String setDataDir = "Transys14.TRACKING.CCF03.C03";
	
		//호기, 위치(순서), 태그경로
		trackingDataSet("3",3,setDataDir);
	}
	
	//[4]확산실(1) : 침탄 처리 종료 및 확산 처리 시작위치
	public void ccf3Tracking04() throws InterruptedException, ExecutionException {
		//Transys.TRACKING.CCF03.C02의 하위태그 조회		
		String setDataDir = "Transys14.TRACKING.CCF03.C04";
		
		//호기, 위치(순서), 태그경로
		trackingDataSet("3",4,setDataDir);
	}
	
	//[5]냉각실(1) : 확산 처리 종료 위치
	public void ccf3Tracking05() throws InterruptedException, ExecutionException{
		
		String setDataDir = "Transys14.TRACKING.CCF03.C05";
		
		trackingDataSet("3",5,setDataDir);
	...
	public void ccf3Tracking06() throws InterruptedException, ExecutionException{
		...
		String setDataDir = "Transys14.TRACKING.CCF03.C06";
			
		trackingDataSet("3",6,setDataDir);
	...
	public void ccf3Tracking07() throws InterruptedException, ExecutionException{
		...
		String setDataDir = "Transys14.TRACKING.CCF03.C07";
				
		trackingDataSet("3",7,setDataDir);
	...
	public void ccf3Tracking08() throws InterruptedException, ExecutionException{
		...
		String setDataDir = "Transys14.TRACKING.CCF03.C08";
					
		trackingDataSet("3",8,setDataDir);
	...
	public void ccf3Tracking09() throws InterruptedException, ExecutionException{
		...
		String setDataDir = "Transys14.TRACKING.CCF03.C09";
						
		trackingDataSet("3",9,setDataDir);
